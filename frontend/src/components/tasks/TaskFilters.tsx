    ...
    <>
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          title="Manage tags"
          className="p-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-500 hover:text-blue-600 hover:border-blue-400 transition-colors"
        >
